package tonfall.format.pcm
{
	...
	{
		[Embed(source="./bin/swf.bin", mimeType="application/octet-stream")] static private const SWF: Class;
		...
		private function generateSound( bytes: ByteArray, info: FormatInfo ): void
		{
			...
			switch( info.samplingRate )
			{
				...
				default: throw FormatError.SAMPLING_RATE;
			}
